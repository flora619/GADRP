...
def train_ae(model,trainLoader,test_feature):
    ...
    for epoch in range(1, 2000 + 1):
        ...
        if epoch%100==0:
            ind = random.sample(range(388), 10)
...
def main():
    ...
    train_ae(RNAseq_ae,data_iter,test)
    torch.save(RNAseq_ae.output(RNAseq_feature),cell_RNAseq_ae)
    ...
    torch.save(copynumber_ae.output(RNAseq_feature), cell_copynumber_ae)
